window.addEventListener(`DOMContentLoaded`, () => {
  ...
  window.addEventListener('hashchange', function () {
    ...
    document.getElementById(`page`).innerHTML =
      "<div class='row fh5co-post-entry single-entry'><article class='col-lg-8 col-lg-offset-2 col-md-8 col-md-offset-2 col-sm-8 col-sm-offset-2 col-xs-12 col-xs-offset-0'><figure><img src='images/hello.jpg' class='img-responsive'></figure><div class='col-md-12'><p>Far far away, behind the word mountains, ff sentences fly into your mouth.</p></div></article></div>";
  });
